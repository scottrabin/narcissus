...
Narcissus.parser = (function() {
    ...
    var _cjsAttachTypes = [ IDENTIFIER, FUNCTION, PROPERTY_INIT, OBJECT_INIT ];
    /*
    ...
    function Node(t, init) {
        ...
        // If there are any comments, attach them to this node
        if( ( t._cjsDocComments.length > 0 ) && ( _cjsAttachTypes.indexOf( this.type ) > -1 ) ){
//            console.log( "attached comments\n\t" + t._cjsDocComments + "\nto node" + this );
            this._cjsDocComments = t._cjsDocComments.pop() ;
        }
    }
